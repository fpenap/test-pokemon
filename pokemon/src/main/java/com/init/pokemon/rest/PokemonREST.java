...
public class PokemonREST {
	...
	public ResponseEntity<String> newPokemon(@RequestBody Pokemon pokemon){
		...
		try {
			...
			br =new BufferedReader(new FileReader("csvpokemon/pokemon.csv"));
		      ...
		      int bandera2 = 0; //Identifica si existe el registro a crear
		      ...
		      while (null!=line1) {
		        	 ...
		        	 if(bandera == 0) {
			             ...
			             String [] fields = line1.split(SEPARATOR);
